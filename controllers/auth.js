...
exports.signup = async (req, res) => {
    const {fname, lname, password, dob, gender, email, phone, city, address, state, pin} = req.body;
    var encrypass = await bcrypt.hash(password, saltRounds);

    var sql = `INSERT INTO users (first_name, last_name, password, gender, dob, email, phone, address, city, state, pin, role) VALUES ('${fname}', '${lname}', '${encrypass}', '${gender}', '${dob}', '${email}', '${phone}', '${address}', '${city}', '${state}', '${pin}', 0)`;
